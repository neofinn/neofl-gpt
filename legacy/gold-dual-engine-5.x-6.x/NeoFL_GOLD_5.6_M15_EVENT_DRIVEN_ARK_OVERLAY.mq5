...
//|                                                                  |
//| NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE - Dedicated Gold Active Scanner                     |
//|                                                                  |
//| PURPOSE                                                          |
...
#property description "NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE - Standalone GOLD Trading Bot"
...
// NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE: GOLD uses the dedicated MT5 account as its full strategy pool. No cross-bot capital sharing.
   ...
   int aliasCount)
{
   ...
   {
      Print(
         "NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | AUTO MAP | ",
         canonical,
         " -> NOT FOUND"
      );
      return;
...
void BuildAutoDetectedUniverse()
{
   ...
   Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | DEDICATED ACTIVE SCAN | GOLD symbols=",MarketCount);
   if(GoldSymbol!="")
      Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | ACTIVE SYMBOL=",GoldSymbol);
   else
      Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | GOLD/XAU SYMBOL NOT FOUND");
}
...
void BuildUniverse()
{
   ...
   for(int i=0;i<n;i++)
   {
      ...
      if(requested=="") continue;       if(!IsGoldSymbolName(requested))
       {
          Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | MANUAL SYMBOL REJECTED (NOT GOLD): ",requested);
         continue;
      }
   ...
   Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | MANUAL GOLD UNIVERSE=",MarketCount);
}
...
void ScanMarkets()
{
   ...
   for(int i=0;i<MarketCount;i++)
   {
      ...
      {
         if(PrintSymbolMapping)
            Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | SCAN REJECTED NON-GOLD: ",Symbols[i]);
         continue;
      }
...
void PrintTopMarkets()
{
   ...
   Print(
      "================ NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE ACTIVE OPPORTUNITY SCAN ================"
   );
   ...
   {
      Print(
         "NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | BEST OPPORTUNITY = ",
   ...
   {
      Print(
         "NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | NO QUALIFIED OPPORTUNITY"
      );
   }
...
void DisplayDashboard()
{
   ...
   string text=
      "NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE - STANDALONE ACTIVE SCANNER\n";
   text+=
      "GLOBAL SESSION: "+
      currentSession+
      "\n";
...
void CancelOurPending(string symbol="")
{
   for(int i=OrdersTotal()-1;i>=0;i--)
   {
      ...
      if(ot==ORDER_TYPE_BUY_STOP || ot==ORDER_TYPE_SELL_STOP)
      {
         ...
         if(PrintExecutionLog) Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | CANCEL PENDING | ",os," ticket=",ticket);
      }
   }
                           ...
                           double entry)
{
   ...
   if(PrintRiskManagerLog)
      Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE CAPITAL | DEDICATED ACCOUNT",
                                  ...
                                  double entry2)
{
   ...
   if(PrintRiskManagerLog)
      Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE CAPITAL | DEDICATED COMBINED",
            " equity=",DoubleToString(accountEquity,2),
            " usable=",DoubleToString(usable,2),
            " required=",DoubleToString(required,2),
            " free=",DoubleToString(accountFree,2),
...
void CancelPendingAfterFill(string symbol)
{
   ...
   if(symbol==GoldSymbol && GoldNewsActive && GoldNewsStraddleArmed)
   {
      if(PrintExecutionLog)
         Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | NEWS RIDER | opposite stop retained");
      return;
   }
         ...
         ot==ORDER_TYPE_BUY_LIMIT || ot==ORDER_TYPE_SELL_LIMIT)
      {
         if(!DryRun)
         {
            if(!trade.OrderDelete(ticket) && PrintExecutionLog)
               Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | OCO DELETE FAILED | ",symbol,
                     " ticket=",ticket," retcode=",trade.ResultRetcode(),
                     " ",trade.ResultRetcodeDescription());
         }
         else if(PrintExecutionLog)
            Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | DRY OCO DELETE | ",symbol," ticket=",ticket);
      }
   }
...
void ProtectGoldPositionOnLiquidityShock(int shockDirection,double atrPrice)
{
   ...
   if(pt==POSITION_TYPE_BUY && shockDirection<0 && bid>0)
   {
      ...
      if(oldSL<=0 || newSL>oldSL)
      {
         ...
         if(PrintExecutionLog)
            Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | SHOCK PROTECT BUY | SL ",
   ...
   if(pt==POSITION_TYPE_SELL && shockDirection>0 && ask>0)
   {
      ...
      if(oldSL<=0 || newSL<oldSL)
      {
         if(!DryRun) trade.PositionModify(GoldSymbol,newSL,tp);
         if(PrintExecutionLog)
            Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | SHOCK PROTECT SELL | SL ",
                  DoubleToString(oldSL,DigitsOf(GoldSymbol))," -> ",
                  DoubleToString(newSL,DigitsOf(GoldSymbol)));
      }
   }
...
bool PlaceGoldNewsStraddle()
{
   ...
   if(a && b)
   {
      ...
      if(PrintExecutionLog)
         Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | NEWS STRADDLE ARMED | ",GoldNewsEventName,
...
void TrailGoldNewsRider()
{
   ...
   else if(dir!=GoldNewsPositionDirection)
   {
      ...
      if(PrintExecutionLog)
         Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | NEWS RIDER REVERSAL | direction=",dir,
   ...
   for(int i=OrdersTotal()-1;i>=0;i--)
   {
      ...
      if(PrintExecutionLog && moved)
         Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | NEWS RIDER TRAIL | posSL=",
               DoubleToString(newSL,DigitsOf(GoldSymbol)),
...
void UpdateGoldNewsEngine()
{
   ...
   if(GoldNewsStraddleArmed)
   {
      ...
      if(!PositionSelect(GoldSymbol))
      {
         ...
         if(PrintExecutionLog)
            Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | NEWS CAMPAIGN COMPLETE | recovery lock started");
      }
   }
}
...
void UpdateGoldLiquidityDefense()
{
   ...
   if(GoldShockActive)
   {
      if(TimeCurrent()>=GoldShockUntil && GoldShockConfirmationComplete())
      {
         ...
         if(PrintExecutionLog)
            Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | SHOCK LOCK CLEARED | scanning resumed");
      }
      return;
   }
   ...
   if(PrintExecutionLog)
      Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | LIQUIDITY SWEEP | ",
...
bool PlaceGoldTrendPending(MARKET_STATE &m)
{
   ...
   {
      if(PrintExecutionLog)
         Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | SMC REQUIRED BLOCK | dir=",tradeDirection,
   ...
   {
      if(PrintRiskManagerLog)
         Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE CAPITAL | GOLD ORDER BLOCKED | bucket limit");
      return false;
   }

   bool ok=false;
   if(PrintExecutionLog)
      Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | SMC TREND | dir=",tradeDirection,
   ...
   if(!DryRun)
   {
      ...
      if(!ok && PrintExecutionLog)
         Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | ORDER FAILED | retcode=",
...
bool PlaceGoldSidewaysStraddle(MARKET_STATE &m)
{
   ...
   double lots=CalculateLots(GoldSymbol,slDist/point);    if(!AccountCapitalAllowsCombined(GoldSymbol,ORDER_TYPE_BUY_STOP,lots,buy,GoldSymbol,ORDER_TYPE_SELL_STOP,lots,sell))
    {
       if(PrintRiskManagerLog)
          Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE CAPITAL | GOLD RANGE BLOCKED | bucket limit");
       return false;
    }

    bool ok1=true,ok2=true;
   if(PrintExecutionLog)
      Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | GOLD SIDEWAYS STRADDLE | ",GoldSymbol," buy=",DoubleToString(buy,DigitsOf(GoldSymbol))," sell=",DoubleToString(sell,DigitsOf(GoldSymbol)));
   if(!DryRun)
   {
             trade.SetExpertMagicNumber(BotMagicNumber);
ok1=trade.BuyStop(lots,buy,GoldSymbol,buySL,buyTP,ORDER_TIME_GTC,0,"NeoFL4.2 GOLD RANGE BUY");
      if(!ok1 && PrintExecutionLog) Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | GOLD BUY STOP FAILED | ",trade.ResultRetcode()," ",trade.ResultRetcodeDescription());
      ok2=trade.SellStop(lots,sell,GoldSymbol,sellSL,sellTP,ORDER_TIME_GTC,0,"NeoFL4.2 GOLD RANGE SELL");
      if(!ok2 && PrintExecutionLog) Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | GOLD SELL STOP FAILED | ",trade.ResultRetcode()," ",trade.ResultRetcodeDescription());
   }
   if(ok1||ok2)
   {
      GoldPendingSymbol=GoldSymbol;
...
void ManageGoldAnchor()
{
   ...
   if(GoldM1LiquidityEnabled && PrintExecutionLog)
   {
      ...
      if(DetectGoldM1Liquidity(ls) &&
         ...
         Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | M1 LIQUIDITY | sweepUp=",ls.bearishSweep,
   ...
   // ================================================================
   // TREND runs continuously. ARK is an independent M15 event overlay:
   // it only becomes active when a new qualifying structural event forms.
   // No ARK event can block a normal Trend trade.
   // ================================================================
      ...
      GoldAllowTrendTrading)
   {
      ...
      double smcPreview=0.0;       bool smcPreviewOK=GoldSMCSupportsDirection(normalDirection,smcPreview);

      normalScore=
         Clamp(g.opportunityScore/100.0,0.0,1.0)*0.40+
         Clamp(MathAbs(g.tf[1].trend),0.0,1.0)*0.35+
         Clamp(g.agreement,0.0,1.0)*0.15+
         (smcPreviewOK ? 0.10 : 0.0);       // M1 is timing/protection, not a universal trend-entry gate.
       if(GoldSMCRequiredForTrade && !smcPreviewOK)
          normalReady=false;

      if(PrintExecutionLog)
         Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | NORMAL ENGINE | ready=",normalReady,
               " dir=",normalDirection,
   ...
   if(PrintExecutionLog)
      Print("NeoFL GOLD 5.6 | ARK M15 EVENT | active=",arkReady,
            " dir=",ark.direction,
   ...
   // ================================================================
   // INDEPENDENT ENGINE MERGER: neither engine waits for the other.
   // ================================================================
   if(normalReady && arkReady)
   {
      bool sameDirection=(normalDirection==ark.direction);

      if(sameDirection)
      {
         if(PrintExecutionLog)
            Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | CONFLUENCE | dir=",
                  normalDirection,
                  " trendScore=",DoubleToString(normalScore,2),
      ...
      {
         if(PrintExecutionLog)
            Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | ENGINE CONFLICT | trendDir=",
                  normalDirection," arkDir=",ark.direction,
                  " trendScore=",DoubleToString(normalScore,2),
                  " arkScore=",DoubleToString(ark.score,2));
         if(ark.score>=normalScore && PlaceGoldArkPending(g,ark))
            return;
         if(normalScore>ark.score && PlaceGoldTrendPending(g))
            return;
      }
   }
   else if(arkReady)
   {
      if(PrintExecutionLog)
         Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | ARK-ONLY | score=",
               DoubleToString(ark.score,2)," dir=",ark.direction);
      if(PlaceGoldArkPending(g,ark))
         return;
   }
   else if(normalReady)
   {
      if(PrintExecutionLog)
         Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | TREND-ONLY | score=",
               DoubleToString(normalScore,2)," dir=",normalDirection);
      if(PlaceGoldTrendPending(g))
         return;
   }

   if(PrintExecutionLog)
      Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | NO QUALIFIED ENGINE | M5=",
...
bool PlaceTrendPending(MARKET_STATE &m)
{
   ...
   {
      if(PrintExecutionLog) Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | ACCOUNT MARGIN BLOCK | ",symbol," | dedicated-account margin protection");
      return false;
   }
   bool ok=false;
   if(PrintExecutionLog) Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | TREND THESIS | ",symbol," dir=",m.direction," score=",DoubleToString(m.opportunityScore,1)," entry=",DoubleToString(entry,DigitsOf(symbol))," tp=",DoubleToString(tp,DigitsOf(symbol)));
   if(!DryRun)
   {
             trade.SetExpertMagicNumber(BotMagicNumber);
if(m.direction>0) ok=trade.BuyStop(lots,entry,symbol,sl,tp,ORDER_TIME_GTC,0,"NeoFL4.2 TREND BUY");
      ...
      if(!ok && PrintExecutionLog) Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | ORDER FAILED | retcode=",trade.ResultRetcode()," ",trade.ResultRetcodeDescription());
   }
   else ok=true;
   if(ok)
   {
...
bool PlaceSidewaysStraddle(MARKET_STATE &m)
{
   ...
   double lots=CalculateLots(symbol,slDist/point);
    ...
    {
       if(PrintRiskManagerLog)
          Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE CAPITAL | ACCOUNT MARGIN BLOCK | ",symbol,
                " | dedicated-account margin protection");
       return false;
    }

    bool ok1=true,ok2=true;
   if(PrintExecutionLog) Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | SIDEWAYS STRADDLE | ",symbol," buy=",DoubleToString(buy,DigitsOf(symbol))," sell=",DoubleToString(sell,DigitsOf(symbol)));
   if(!DryRun)
   {
             trade.SetExpertMagicNumber(BotMagicNumber);
ok1=trade.BuyStop(lots,buy,symbol,buySL,buyTP,ORDER_TIME_GTC,0,"NeoFL4.2 RANGE BUY");
      if(!ok1 && PrintExecutionLog) Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | BUY STOP FAILED | ",trade.ResultRetcodeDescription());
      ok2=trade.SellStop(lots,sell,symbol,sellSL,sellTP,ORDER_TIME_GTC,0,"NeoFL4.2 RANGE SELL");
      if(!ok2 && PrintExecutionLog) Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | SELL STOP FAILED | ",trade.ResultRetcodeDescription());
   }
   if(ok1||ok2)
   {
...
bool ManageCandleStructureTrail()
{
   ...
   for(int i=PositionsTotal()-1;i>=0;i--)
   {
      ...
      {
         if(PrintExecutionLog)
            Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | CANDLE TRAIL FAILED | ",symbol,
                  " ticket=",ticket,
      ...
      else
      {
         any=true;
         if(PrintExecutionLog)
            Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | CANDLE TRAIL | ",symbol,
                  " ticket=",ticket,
...
bool ManageAllPositions()
{
   ...
   for(int i=PositionsTotal()-1;i>=0;i--)
   {
      ...
      {
         if(PrintExecutionLog)
            Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | ",reason," FAILED | ",symbol,
                  " ticket=",ticket,
                  " retcode=",trade.ResultRetcode(),
                  " ",trade.ResultRetcodeDescription(),
                  " oldSL=",DoubleToString(sl,DigitsOf(symbol)),
      ...
      {
         Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | ",reason," | ",symbol,
               " ticket=",ticket,
               " profitR=",DoubleToString(profitR,2),
...
void EvaluatePendingThesis()
{
   ...
   {
      if(PrintExecutionLog) Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | THESIS EXPIRED | ",PendingSymbol);
   ...
   {
      if(PrintExecutionLog) Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | THESIS INVALIDATED | ",PendingSymbol," trend=",DoubleToString(m.trend,2));
...
void FindAndExecuteBest()
{
   ...
   if(m.regime==MARKET_STRONG_UP || m.regime==MARKET_STRONG_DOWN)
   {
      ...
      {
         if(PrintExecutionLog)
            Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | M5 PRIMARY TREND GATE BLOCK | symbol=",m.symbol,
...
int OnInit()
{
   ...
   Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | DEDICATED ACCOUNT | "
         "STRATEGY CAPITAL=100% | NO STANDALONE MARKET | BASE BALANCE=",
         DoubleToString(CapitalLedgerStartBalance,2));

   if(MarketCount==0)
   {
      Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | NO USABLE "
   ...
   Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE STARTED | "
         "DEDICATED ACTIVE SCANNER | symbols=",MarketCount,
         " | scan=",ScanSeconds,"s | host=",_Symbol);

   Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | Scanner reads only the "
                        ...
                        const MqlTradeResult &result)
{
      ...
      GoldBlockOppositeAfterStop)
   {
         ...
         (GoldShockEventBar>0 && TimeCurrent()-GoldShockEventBar<=GoldShockLockSeconds))
      {
         ...
         if(PrintExecutionLog)
            Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | STOP DURING/AT LIQUIDITY EVENT | ",
   ...
   if(PrintExecutionLog)
      Print("NeoFL GOLD 5.6 DUAL INDEPENDENT ENGINE | FILL DETECTED | ",symbol,
