...
void DashUpdate()
{
   ...
   DashText("Version","v3.67",x+w-78,y+94,11,clrLime,"Arial Bold");
...
int OnInit()
{
   ...
   Print("NeoFL Candle Revisit Engine v3.67 initialized. M5 entry engine only; M1 continuous monitor/protection.");
   DashUpdate();
